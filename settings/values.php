...
",
    ...
    'buy_account_cart_to_cart'=>"عزیزم یه تصویر از فیش واریزی رو بفرست :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

✅ بعد از اینکه پرداختت تایید شد ( لینک سرور ) به صورت خودکار از طریق همین ربات برات ارسال میشه!",
    'renew_ccount_cart_to_cart'=>"عزیزم یه تصویر از فیش واریزی رو بفرست :
...
",
    ...
    'send_only_number'=> "لطفا فقط عدد بفرستید",
