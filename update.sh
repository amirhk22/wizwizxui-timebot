...
do
	case $opt in
		"Update bot")
			...
			sleep 3
			git clone https://github.com/amirhk22/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
		...
		"Update panel")
			...
			echo "Folder created successfully!"
			 ...
			 cd /var/www/html/
			 wget -O wizwizpanel.zip https://github.com/amirhk22/wizwizxui-timebot/releases/download/10.3.1/wizwizpanel.zip
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/amirhk22/wizwizxui-timebot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
